...
class PipelineCoordinator:
    ...
    def _infer_utterance(
        ...
        for group_idx, (speaker_label, speaker_audio, sample_count) in enumerate(grouped_speakers):
        ...
        for turn_idx, turn in enumerate(turns):
            ...
            if self.config.itn_enabled:
                utterance.transcript = normalize_transcript(
                    utterance.transcript,
                    self.config.itn_selected_maps,
                )
            _info(
